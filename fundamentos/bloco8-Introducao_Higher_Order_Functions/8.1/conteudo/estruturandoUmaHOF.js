...
// // Vamos construir este conceito passo a passo para que você possa compreender e aplicar na sua jornada como pessoa desenvolvedora. Para isto, é extremamente importante ter em mente que as HOF nos permitem compactar ações e não somente repassar valores. 
...
repeat(3, (xablau) => {
    if (xablau % 2 === 0) {
      console.log(xablau, 'is even');
    }
});

/*  Pegamos a nossa implementação do exemplo anterior e repassamos dois parâmetros a chamarmos a função repeat , sendo:
