...
/* Perceba que a diferença entre elas é o async . Como existe uma promise a ser testada, é necessário o uso do await , para que o teste espere a finalização da promise e, em seguida, execute o teste remanescente. 
A variável listDogs recebe o retorno da promise que será utilizado para fazer as asserções.
...
/* Repare que se findAnimalsByType não lançar o erro como esperamos o bloco do catch não será executado, fazendo com que a nossa asserção não tenha efeito e o teste seja um falso-positivo, logo da mesma forma que usamos expect.assertions com promises também precisamos usar com o async/await , para garantir que caso a asserção não seja executada o teste falhe. */
