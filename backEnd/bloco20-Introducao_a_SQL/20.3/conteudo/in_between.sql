...
*/
SELECT first_name, last_name, email FROM sakila.customer WHERE last_name 
IN ('hicks', 'crawford', 'henry', 'boyd', 'mason', 'morales', 'kennedy') ORDER BY first_name;
...
*/
SELECT COUNT(*) FROM sakila.payment WHERE DATE(payment_date) BETWEEN '2005-05-01' AND '2005-08-01';

/*
	4- Mostre o título, ano de lançamento e duração do empréstimo de todos os filmes 
    com a duração de empréstimo de 3 a 6.
...
*/
SELECT title, release_year, rental_duration FROM sakila.film WHERE rental_duration BETWEEN 3 AND 6 
