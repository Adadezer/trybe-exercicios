...
/*
	3- Usando a tabela rental,
    extraia data, ano, mês, dia, hora, minuto e segundo dos registros com rental_id = 10330. 
    Utilize a coluna rental_date para extrair as informações.
*/
SELECT
DATE(rental_date), YEAR(rental_date), MONTH(rental_date), DAY(rental_date),
