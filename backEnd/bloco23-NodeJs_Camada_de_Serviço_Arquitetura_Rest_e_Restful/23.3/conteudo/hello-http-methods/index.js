...
// Para aquecer, vamos começar com uma requisição do tipo `GET/ POST`
const verboHTTP = 'post';
fetch(`https://postman-echo.com/${verboHTTP}?param1=teste`, {
  // Passamos o objeto de headers como parâmetro para o fetch  
  headers,
  //adicionamos o metodo post
  method: 'POST',
