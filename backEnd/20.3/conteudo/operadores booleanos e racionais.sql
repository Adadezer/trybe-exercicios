...
/*
    ...
    As informações podem ser encontradas na tabela customer
*/
SELECT first_name FROM sakila.customer WHERE active = 0 AND (store_id = 2 AND first_name <> 'KENNETH')
ORDER BY first_name;

/*
	3 - O setor financeiro quer saber título, descrição, ano de lançamento 
    ...
    entre os filmes feitos para menores de idade 
