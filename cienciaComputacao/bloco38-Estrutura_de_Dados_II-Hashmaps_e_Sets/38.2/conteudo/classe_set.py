# Podemos instanciar um set vazio
# ou inicializar com valores de um objeto iterável, como uma lista
conjuntoA = set()
print(conjuntoA)

# Ao inicializar com valores de uma lista, os valores duplicadosserão desconsiderados
# e a ordem de inserção será perdida.
...
# sets admitem objetos mistos.
# Ou seja, admitem ter _strings_ com _ints_ dentro de um mesmo objeto, por exemplo.
...
print('some element: ',some_element)
